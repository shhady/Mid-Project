  ...
  return (
    <div className="MainContainer">
      ...
      <p>
        ...
        decentralized software platform used for its cryptocurrency, Ether. It
        enables SmartContracts and Distributed Applications (ĐApps) to be
        created and run without any downtime, fraud, control or third party
        interference. Ethereum is not just a platform but also a Turing Complete
        programming language that runs on the blockchain, helping developers
        create and publish distributed applications.
      </p>
      <h2>Main Points</h2>
      <p>
        1. Ethereum is an open source computing platform and operating system.
        <br />
        2. It has its own cryptocurrency, ether. (Ether)
        <br /> 3. One of the big projects around Ethereum is Microsoft's
        partnership with ConsenSys.
      </p>
      <h2>Understanding Ethereum</h2>
      <p>
        Applications that run on Ethereum run on the platform's own
        cryptographic token, Ether. During 2014, Ethereum launched an initial
        sale of Ether which received an overwhelming response. Ether is
        considered as a way to navigate the Ethereum platform and is mostly
        sought by developers looking to develop and run applications within the
        Ethereum platform. Ether is widely used for two purposes: it is traded
        as a digital currency exchanger like other cryptocurrencies, and it is
        used within the Ethereum platform to run applications and even to
        monetize the business. According to Ethereum, it can be used to blog,
        decentralize, secure and trade anything. One of the big projects around
        Ethereum is Microsoft's partnership with ConsenSys which offers
        "Ethereum Blockchain as a Service (EBaaS) on Microsoft Azure so that
        Enterprise customers and developers can have a one-click cloud-based
        developer environment." In 2016, Ethereum was split into two separate
        groups, Ethereum and Ethereum Classic, after one of them stole more than
        $50 million in funds raised on the DAO, a suite of smart contracts that
        originated from the Ethereum software platform. The new Ethereum was a
        split from the original program with the aim of protecting against
        further attacks. As of September 2019, Ethereum was the second largest
        virtual currency in the market, after only Bitcoin. Getting ether is
        much faster and cheaper than getting bitcoin, and there are much more
        ether units in circulation than bitcoin.
      </p>
      <h2>How to buy ethereum Coin (Ether)</h2>
      <p>
      ...
      <h2>How to sell ethereum</h2>
      <p>
        You can sell Ether at the same places where you purchased the
        cryptocurrency, such as cryptocurrency exchanges, or individually. The
        process of selling ether on these platforms is usually the same as
